    ...
    <>
      <section className="bg-white overflow-y-hidden dark:bg-gray-900">
        <div className="flex flex-col items-start justify-center max-w-screen-xl w-full px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
          <div class="mb-4">
            <div class="mb-6 max-w-3xl text-left md:mx-auto md:mb-12">
                    ...
                    <div class="mx-0 mb-1 sm:mb-4">
                      <div class="mx-0 mb-1 sm:mb-4">
                        ...
                        <input
                          ...
                          class="mb-2 w-full rounded-md border border-gray-200 dark:border-gray-700 outline-none py-2 pl-2 pr-4 shadow-md dark:text-gray-300 bg-gray-50 dark:bg-gray-800 focus:outline-double focus:outline-[#f35a57] focus:scale-105 transition-all sm:mb-0"
