...
import authregister from "../../img/auth/authregister.svg";
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    ...
                    />
                    <i className="bi bi-person-add absolute right-5 top-1/2 -translate-y-1/2  text-gray-400"></i>
                  </div>
                </div>
                {/* Email */}
                <div>
                  ...
                  <div className="relative flex items-center">
                    ...
                    />
                    <i className="bi bi-envelope absolute right-5 top-1/2 -translate-y-1/2 text-gray-400"></i>
                  </div>
                </div>
                {/* password */}
                <div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div className="flex items-center">
                    ...
                    <label
                      htmlFor="terms"
                      className="ml-3 block space-x-1 text-sm cursor-pointer text-gray-800 dark:text-gray-200"
                    >
                      <span>Accept</span>
                      <Link
                        to="/terms"
